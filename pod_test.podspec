...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/peiwenqin/pod_test'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'peiwenqin' => 'wenqin.pei@wowjoy.cn' }
  s.source           = { :git => 'https://github.com/peiwenqin/pod_test.git', :tag => s.version.to_s }
